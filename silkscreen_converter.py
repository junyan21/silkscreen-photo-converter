...
class SilkscreenConverter:
        ...
        for y in range(y_start, y_end):
            for x in range(x_start, x_end):
                ...
                if shape == 'circle':
                    ...
                    draw_pixel = abs(rotated_y) <= radius * 0.3 and abs(rotated_x) <= radius
    ...
    def save_pdf(self, image, output_path, dpi=300):
        ...
        if not PDF_AVAILABLE:
            raise click.ClickException("PDF出力にはreportlabが必要です: pip install reportlab")
    ...
    def save_ai(self, image, output_path, dpi=300):
        ...
        try:
            ...
            if self.dot_data:
                ...
                img_element.set('xlink:href', f'data:image/png;base64,{img_data}')
...
def main(input_path, output_path, lines, angle, dot_shape, contrast, 
    ...
    if batch:
        ...
        for file in image_files:
            ...
            try:
                converter.convert(input_file, output_file, lines, angle, dot_shape,
